...
export const RevenueCatProvider = ({ children }: any) => {
  ...
  const updateCustomerInformation = async (customerInfo: CustomerInfo) => {
    ...
    if (customerInfo?.entitlements.active['Epic Wand'] !== undefined) {
      newUser.items.push(customerInfo?.entitlements.active['Epic Wand'].identifier as string);
    }

    if (customerInfo?.entitlements.active['Magic Boots'] !== undefined) {
      newUser.items.push(customerInfo?.entitlements.active['Magic Boots'].identifier as string);
    }
